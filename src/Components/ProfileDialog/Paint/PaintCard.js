...
componentDidMount(){
  ...
  var return_time = [];
  var return_cats = ['Interior', 'Exterior', 'Engine', 'Driver Assist', 'MPG', 'Wheels', 'Amenities'];
var  array = ['Interior', 'Exterior', 'Engine', 'Driver Assist', 'MPG', 'Wheels', 'Amenities'];
...
<Typography gutterBottom>Interest Category Distribution</Typography>
<Bar
